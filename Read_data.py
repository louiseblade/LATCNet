...
# this is for dataset 2a npz usage only
class Read_Data:
    ...
    def get_trial_from_ch(self, channel):
        ...
        for index in idxs:
            try:
                ...
                stop = start + self.events_duration[0][index] - 375
...
def create_single_subject_raw_data(X_train, X_test, y_train, y_test, subject_num):
...
if __name__ == '__main__':
    data = "BCICIV2a_npz/data_npz" #eogremoval
    label = "BCICIV2a_npz/true_labels"
    ...
    create_single_subject_raw_data(X_train, X_test, y_train, y_test, subject_num=subject_num)
